        ...
        <?php
          if( $properties_result && mysqli_num_rows($properties_result)>0 )   //When entered city has more than one properties.
          {
            ...
            while( $property_row = mysqli_fetch_assoc($properties_result) )
            {
              ...
              // $image_directory = "img/properties/$pg_id/";
              // $images = glob($image_directory . "*.jpg"); // Fetch all .jpg files in the folder
              $image_directory = "./img/properties/$pg_id/";
              $images = glob($image_directory . "*.jpg"); // Fetch all .jpg files in the folder
              $first_image = isset($images[0]) ? $images[0] : 'img/default.jpg'; // Use the first image or a default image
              ...
              <div class="property-card row">
                  ...
                  <!-- <div class="image-container col-md-4">
                      ...
                      if (!empty($images)) {
                          ...
                          echo "<img src='img/default.jpg' />"; // Fallback image if no property images are available
                      }
                      ?>
                  </div>-->
                  <div class="image-container col-md-4">
