...
?>
    <!-- Navbar -->
    <!-- <nav class="navbar">
      <a href="index.php" class="navbar-brand">PGLife</a>
      <div class="dark-mode-toggle">
        <button id="darkModeToggle" class="btn btn-dark btn-sm" style="padding: 2px 8px; height: 20px; border-radius: 4px;">
          <img src="./img/darkmodemoon.png" alt="Dark Mode Icon" style="width: 12px; height: 12px;">
        </button>
      </div>
    </nav> -->
    ...
    <div class="property-summary page-container">
      ...
      <div class="row no-gutters">
          ...
          <div class="button-container col-6">
              <a href="book_property.php" class="btn btn-primary">Book Now</a>
          </div>
      </div>
    </div>
    <!-- <div id="bookingMessage" style="display:none; padding: 20px; background-color: green; color: white; text-align: center; font-weight: bold;">
      Booking Successful!
    </div> -->
